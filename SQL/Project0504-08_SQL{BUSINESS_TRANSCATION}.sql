--As a alumni association vice president, I want to know which city has the most alumni live in, so that we can hold an alumni event in this city--
...
--As a alumni association vice president, I want to know which top 3 skills has the most alumni own,--
...
--As a alumni association vice president, I want to know which company has the most alumni works in, so that we can recommend students to intern there.
...
--As the alumni association vice president, 
--I want to know the job roles that have greater than 10 of our alumni, so that we can build our students based on the requirement of these job roles.
